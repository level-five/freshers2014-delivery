...
public class ClientDataTest {
	...
	@Test(expected = RuntimeException.class)
	public void testインスタンス化時の引数がAAと1234567と12345678と午前のとき例外が発生する() {
		clientData = new ClientData("AA", 1234567, 12345678, "午前");
	}
	@Test 
	public void testインスタンス化時の引数が空文字と1234567と12345678と午前のときgetShippingMethodで空文字が返る(){
