...
public class ShippingDataByServiceBTest {
	...
	public void test郵便番号が1で始まり2014年4月13日夕方が到着日に指定されたときに例外が返る() {
		// 2014年4月13日は日曜
		StringBuilder sb = shippingDataByServiceB.preSendShippingDate(1, 20140413, "夕方");
	}
	@Test(expected = RuntimeException.class)
	...
	public void test郵便番号が1で2014年4月11日夕方が到着日のデータが入ったClientDataのオブジェクトを受け取って2014年4月11日午前と2014年4月10日午後が返る(){
		...
		StringBuilder sb = shippingDataByServiceB.sendShippingDate(clientData);
		String str = "2014年4月11日午前、2014年4月10日午後";
		assertEquals(str, sb.toString());	
	}
	@Test(expected = RuntimeException.class)
